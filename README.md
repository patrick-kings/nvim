...
```sh
git clone https://github.com/patrick-kings/nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/patrick-kings/nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/patrick-kings/nvim.git "${env:LOCALAPPDATA}\nvim"
```
